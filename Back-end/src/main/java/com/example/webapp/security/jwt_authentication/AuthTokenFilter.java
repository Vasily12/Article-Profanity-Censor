...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    //Checks if a valid JWT token is present in the request
    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
            throws ServletException, IOException {
        try {
            String jwt = parseJwt(request);
            //If valid JWT token, get details and set them in security context
        ...
        //Forward the request to the rest of the system
        filterChain.doFilter(request, response);
    }

    //Retrieves the JWT token from the header of the request
